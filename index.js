...
async function startXeonBotInc() {
                    ...
                    await XeonBotInc.sendMessage(mek.key.remoteJid, { 
                        ...
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                newsletterJid: '120363283474698207@newsletter',
                                newsletterName: 'Admin Bot by ZAIB',
                                serverMessageId: -1
                            }
                        }
                    }).catch(console.error);
    ...
    XeonBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || 'Admin Bot'} ]`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: @ZAIBITECH-1`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: zaibitech`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: RAO ZAIB`))
